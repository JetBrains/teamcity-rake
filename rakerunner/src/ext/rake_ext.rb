...
if ENV["idea.rake.debug"]
  require File.expand_path(File.dirname(__FILE__) + '/../ext/lib/ruby/1.8/test/unit/teamcity/message_factory')
  require File.expand_path(File.dirname(__FILE__) + '/../ext/lib/ruby/1.8/test/unit/teamcity/event_queue/event_queue')
else
  require 'test/unit/teamcity/message_factory'
  require 'test/unit/teamcity/event_queue/event_queue'
end
######################################################################
######################################################################
